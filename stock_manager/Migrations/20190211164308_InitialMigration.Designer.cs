...
namespace stock_manager.Migrations
{
    ...
    [Migration("20190211164308_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stock_manager.Models.Tipo_Documento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("stock_manager.Models.Tipo_Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("stock_manager.Models.Contactos", b =>
                {
                    b.HasOne("stock_manager.Models.Tipo_Documento", "Tipo_Documento")
                        .WithMany()
                        .HasForeignKey("Id_Tipo_Documento")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("stock_manager.Models.Tipo_Persona", "Tipo_Persona")
                        .WithMany()
